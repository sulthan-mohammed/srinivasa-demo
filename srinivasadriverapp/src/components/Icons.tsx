...
export const FlightIcon: React.FC<IconProps> = ({ size = 24, color = '#6C4CF1' }) => (
...
export const CarIcon: React.FC<IconProps> = ({ size = 24, color = '#6C4CF1' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const CalendarIcon: React.FC<IconProps> = ({ size = 24, color = '#6C4CF1' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const LocationIcon: React.FC<IconProps> = ({ size = 24, color = '#6C4CF1' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const PersonIcon: React.FC<IconProps> = ({ size = 24, color = '#6C4CF1' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const TimeIcon: React.FC<IconProps> = ({ size = 24, color = '#6B7280' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const RouteIcon: React.FC<IconProps> = ({ size = 24, color = '#6B7280' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const MoneyIcon: React.FC<IconProps> = ({ size = 24, color = '#6B7280' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
...
export const NavigationIcon: React.FC<IconProps> = ({ size = 24, color = '#6C4CF1' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
